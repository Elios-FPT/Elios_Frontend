      ...
      <div id="header-section-landingPage">
        <Navbar expand="lg" id="navbar-custom-landingPage">
          ...
          <Nav className="ml-auto" id="nav-links-landingPage">
            ...
            <Nav.Link href="#">{t("landingPage.navbar.forum")}</Nav.Link>
            <Nav.Link href="#">{t("landingPage.navbar.codingChallenge")}</Nav.Link>
            <Nav.Link href="#">{t("landingPage.navbar.buildCV")}</Nav.Link>
